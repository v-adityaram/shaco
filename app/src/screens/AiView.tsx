...
export function AiView({
  ...
  return (
    <div className="relative min-h-full bg-slate-950 text-slate-200">
      ...
      <div className="mx-auto max-w-6xl px-4 py-5">
        ...
        {showDiff && (
          <div className="mt-4 rounded-lg border border-emerald-500/30 bg-emerald-500/5 p-4">
            <div className="mb-2 flex items-center gap-2">
              <h2 className="text-[13px] font-semibold tracking-wide text-emerald-300 uppercase">
                What changed
              </h2>
              <button
            ...
            <div className="mt-2 grid grid-cols-1 gap-3 sm:grid-cols-2">
              ...
              <div>
                <div className="text-[10px] text-emerald-500 uppercase">After</div>
                <ol className="mt-1 space-y-0.5 text-[12px] text-emerald-200">
            ...
            <ul className="mt-2 list-inside list-disc space-y-1 text-[11.5px] text-slate-300">
        ...
        <div className="mt-5 flex justify-center pb-8">
          <button
            ...
            className="rounded-md border border-amber-500/40 bg-amber-500/10 px-4 py-2 text-[12.5px] font-medium text-amber-300 transition hover:bg-amber-500/20 disabled:cursor-not-allowed disabled:opacity-40"
          >

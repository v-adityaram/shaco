  ...
  return (
    <FactPanel title="Blast radius">
      <div className="grid grid-cols-2 gap-3 text-[12.5px]">
        <div className="rounded bg-slate-100 dark:bg-slate-900/50 p-2.5">
        ...
        <div className="col-span-2 rounded bg-slate-100 dark:bg-slate-900/50 p-2.5">
        ...
        {data.partner_feed_impacted != null && (
          <div className="col-span-2 text-[11.5px] text-slate-500 dark:text-slate-400">
            Partner B2B feed impacted:{' '}
            <span className={data.partner_feed_impacted ? 'text-amber-700 dark:text-amber-300' : 'text-emerald-700 dark:text-emerald-300'}>

      ...
      <div className="space-y-4">
        {hypotheses
          ...
          .map((h) => (
            <div
              key={h.rank}
              className="rounded-lg border border-indigo-400/25 bg-slate-900/40 p-3"
            >
              <div className="flex items-start justify-between gap-2">
                <div className="flex items-baseline gap-2">
                  <span className="text-[11px] font-bold text-indigo-300">#{h.rank}</span>
                  <span className="text-[13.5px] font-medium text-slate-100">{h.cause}</span>
                </div>
                <span
              ...
              <div className="mt-3 border-t border-slate-700/50 pt-2 text-[11.5px] text-slate-400">
                <span className="font-medium text-slate-300">What would change this: </span>
